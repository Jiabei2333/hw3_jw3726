...
One illstrative example can be that Bulgarian Yogurt which has order id " 49302" belongs to the alsle "yogurt" is ordered on the fourth day of the week with order number 4. 
